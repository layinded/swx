...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("proposed_by", sa.dialects.postgresql.UUID(as_uuid=True), sa.ForeignKey("swx_admin_users.id"), nullable=False),
        sa.Column("approved_by", sa.dialects.postgresql.UUID(as_uuid=True), sa.ForeignKey("swx_admin_users.id"), nullable=True),
