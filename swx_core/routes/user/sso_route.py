...
async def initiate_sso(
    ...
    return await initiate_sso_controller(session, user.id, body.provider_id, body.metadata_)
...
async def list_my_sessions(
    ...
    return await list_sessions_controller(session, user_id=user.id, skip=skip, limit=limit)
...
async def terminate_my_session(
    ...
    return await terminate_session_controller(session, sso_session_id, user.id)